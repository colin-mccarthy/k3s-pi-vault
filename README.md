...
There are many ways to inject variables into the pod, I have some [notes](https://github.com/colin-mccarthy/k3s-pi-vault/blob/master/notes/vars.md) on the different patterns.
